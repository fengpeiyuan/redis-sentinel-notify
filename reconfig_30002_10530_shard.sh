...
echo "CurrTime:$CurrTime - CurrIp:$CurrIp - currPort:$currPort - FromIp:$FromIp - FromPort:$FromPort - ToIp:$ToIp - ToPort:$ToPort - ZK_VALUE:$ZK_VALUE - Rst:$Rst " >> /var/log/sentinel_30002_10530.log
