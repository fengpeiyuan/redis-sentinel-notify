...
echo "CurrTime:$CurrTime - CurrIp:$CurrIp - currPort:$currPort - FromIp:$FromIp - FromPort:$FromPort - ToIp:$ToIp - ToPort:$ToPort - Rst:$Rst " >> /var/log/sentinel_30001_10627.log
